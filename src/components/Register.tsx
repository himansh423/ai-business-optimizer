    ...
    <div className="w-screen min-h-screen py-10 flex justify-center items-center">
      ...
      >
        <div className="py-6 w-full flex flex-col gap-2">
          <h1 className={`${inter.className} text-[#fafafa] text-2xl font-bold`}>Create an account</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
          <div className="flex flex-col gap-2 w-full">
            <label htmlFor="fullName" className={`${inter.className} text-[#fafafa] text-[14px] font-semibold`}>
              Full Name*
            </label>
            <input
              type="text"
            ...
            />
            {errors.name && <p style={{ color: "orangered" }}>{errors.name.message}</p>}
          </div>
          <div className="flex flex-col gap-2 w-full">
            <label htmlFor="email" className={`${inter.className} font-semibold text-[14px] text-[#fafafa]`}>
              Email*
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-2 w-full">
            <label htmlFor="password" className={`${inter.className} font-semibold text-[14px] text-[#fafafa]`}>
              Password*
            </label>
            <input
              {...register("password")}
          ...
          <div className="flex flex-col gap-2 w-full">
            <label htmlFor="confirmPassword" className={`${inter.className} font-semibold text-[14px] text-[#fafafa]`}>
              Confirm Password*
            </label>
            <input
          ...
          {errors.isAgreement && <p style={{ color: "orangered" }}>{errors.isAgreement.message}</p>}
          {errors.root && <p style={{ color: "orangered" }}>{errors.root.message}</p>}
        ...
        <p className={`${inter.className} text-[14px] mt-4 text-center text-[#a1a1aa]`}>
